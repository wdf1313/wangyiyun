...
function reducer(state=defaultState,action){
    switch(action.type){
        case actionTypes.CHANGE_CURRENT_SONGS:
            return state.set("currentSong",action.currentSong)
        case actionTypes.CHANGE_PLAY_LIST:
            return state.set("playList",action.playList)
        case actionTypes.CHANGE_SONG_INDEX:
            return state.set("songIndex",action.index)
        case actionTypes.CHANGE_SQUENCE:
        ...
        case actionTypes.CHANGE_SIMI_SONG:
          return state.set("simiSong",action.songs)
        ...
        case actionTypes.CHANGE_HOT_COMMENT:
          return state.set('hotcomment',action.hotcomments)    
        default:
            return state
    }
}
